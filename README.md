...
```
docker build -t catrielmuller/aws-cli-docker:x.x .
```
...
An automated build of this image is on Docker Hub: https://hub.docker.com/r/catrielmuller/aws-cli-docker/
